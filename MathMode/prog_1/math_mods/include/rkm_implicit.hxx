#ifndef RKM_IMPLICIT_HXX
#define RKM_IMPLICIT_HXX
...
class RKM_implicit : public RKM<U_arg, T_arg>
{
    public:
        RKM_implicit() = default;

        RKM_implicit(const std::function<U_arg(U_arg, T_arg)> func,
                           const U_arg& u_start,
                           const T_arg& t_start,
                           const T_arg& dt,
...
Math_Vector<U_arg> RKM_implicit<U_arg, T_arg, stage>:: get_K()
  {
